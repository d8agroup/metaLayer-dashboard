...
urlpatterns = patterns('',
    ...
    url(r'data_points/oauth2/check_credentials$', dashboard_data_point_oauth_credentials_are_valid),
    url(r'data_points/oauth2/poll_for_new_credentials$', dashboard_data_point_oauth_poll_for_new_credentials),
    url(r'data_points/oauth2/authenticate$', dashboard_oauth_authenticate),
    url(r'data_points/oauth2/persist_store$', dashboard_oauth_persist_store),
